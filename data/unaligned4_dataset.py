...
class Unaligned4Dataset(BaseDataset):
    """
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase4 + 'A')  # create a path '/path/to/data/trainA'
       ...
       # self.B20_size = len(self.B20_paths)  # get the size of dataset B
        ...
        self.dir_B50 = os.path.join(opt.dataroot, opt.phase4 + 'B50')  # create a path '/path/to/data/trainB1'
        #self.dir_B2 = os.path.join(opt.dataroot, opt.phase + 'B2')  # create a path '/path/to/data/trainB2'
        ...
        self.dir_B100 = os.path.join(opt.dataroot, opt.phase4 + 'B100')  # create a path '/path/to/data/trainB1'
        ...
        self.dir_B150 = os.path.join(opt.dataroot, opt.phase4 + 'B150')  # create a path '/path/to/data/trainB1'
